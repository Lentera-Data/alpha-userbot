...
CMD_HELP.update({
    "chat":
    "• `.chatid`\n"
    "Usage: Fetches current chat's ID\n\n"
    "• `.userid`\n"
    "Usage: Fetches ID of replied user, or source ID of forwarded message.\n\n"
    "• `.log`\n"
    "Usage: Forwards replied message to your bot's logs group.\n\n"
    "• `.kickme`\n"
    "Usage: Leaves the targeted group.\n\n"
    "• `.unmutechat`\n"
    "Usage: Unmutes a muted chat.\n\n"
    "• `.mutechat`\n"
    "Usage: Mutes any chat.\n\n"
    "• `.link <username/userid> : <optional text>` or reply to someone's message with "
    "`.link <optional text>`\n"
    "Usage: Generates a permanent link to the user's profile with optional custom text.\n\n"
    "• `.regexninja <on/off>`\n"
    "Usage: Globally enables/disables the regex ninja module."
